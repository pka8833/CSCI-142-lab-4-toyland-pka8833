...
public class TestRCCar {
    ...
    public void testFirstRCCar() {
        ...
        assertEquals(300, car1.getProductCode());
        ...
        assertEquals("Toy{PC:300, N:Herbie, H:0, R:false, W:0.0}, BatteryPowered{BL:100, NB:4}, RCCar{S:10}", car1.toString());

        car1.play(60);
        String expected = "PLAYING(60): Toy{PC:300, N:Herbie, H:0, R:false, W:0.0}, BatteryPowered{BL:100, NB:4}, RCCar{S:10}" + System.lineSeparator();
        ...
        car1.play(12);
        expected = "PLAYING(12): Toy{PC:300, N:Herbie, H:60, R:false, W:10.0}, BatteryPowered{BL:36, NB:4}, RCCar{S:15}" + System.lineSeparator();
        ...
        outputStreamCaptor.reset();
        car1.play(37);
        expected = "PLAYING(37): Toy{PC:300, N:Herbie, H:72, R:false, W:25.0}, BatteryPowered{BL:20, NB:4}, RCCar{S:20}" + System.lineSeparator();
        expected += "\tHerbie races around at 20mph!" +  System.lineSeparator();
        expected += "\tDEPLETED:Toy{PC:300, N:Herbie, H:72, R:false, W:25.0}, BatteryPowered{BL:0, NB:4}, RCCar{S:20}"  + System.lineSeparator();
        expected += "\tRECHARGED:Toy{PC:300, N:Herbie, H:72, R:false, W:25.0}, BatteryPowered{BL:100, NB:4}, RCCar{S:20}"  + System.lineSeparator();
        expected += "RETIRED: Toy{PC:300, N:Herbie, H:109, R:true, W:45.0}, BatteryPowered{BL:100, NB:4}, RCCar{S:25}";
        assertEquals(expected, outputStreamCaptor.toString()
                .trim());
    ...
    public void testSecondRCCar() {
        ...
        assertEquals(301, car2.getProductCode());
        ...
        assertEquals("Toy{PC:301, N:BatMobile, H:0, R:false, W:0.0}, BatteryPowered{BL:100, NB:10}, RCCar{S:10}", car2.toString());

        car2.play(98);
        String expected = "PLAYING(98): Toy{PC:301, N:BatMobile, H:0, R:false, W:0.0}, BatteryPowered{BL:100, NB:10}, RCCar{S:10}" + System.lineSeparator();
        expected += "\tBatMobile races around at 10mph!" + System.lineSeparator();
        expected += "\tDEPLETED:Toy{PC:301, N:BatMobile, H:0, R:false, W:0.0}, BatteryPowered{BL:0, NB:10}, RCCar{S:10}" + System.lineSeparator();
        expected += "\tRECHARGED:Toy{PC:301, N:BatMobile, H:0, R:false, W:0.0}, BatteryPowered{BL:100, NB:10}, RCCar{S:10}";
        assertEquals(expected, outputStreamCaptor.toString()
                .trim());
        ...
        outputStreamCaptor.reset();
        car2.play(1);
        expected = "PLAYING(1): Toy{PC:301, N:BatMobile, H:98, R:false, W:10.0}, BatteryPowered{BL:100, NB:10}, RCCar{S:15}" + System.lineSeparator();
